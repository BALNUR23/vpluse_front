...
const ROLE_ICONS = {
  intern: '🎓', employee: '💼', projectmanager: '📋', admin: '🛡️', superadmin: '👑',
};
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div className="form-group">
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input className="form-input" type="text" placeholder="Введите логин"
                value={loginVal} onChange={e => setLoginVal(e.target.value)}
                style={{ paddingLeft: 32 }} autoComplete="username" />
            </div>
          </div>
